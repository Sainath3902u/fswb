...
export default function ManageMenuPage() {
  ...
  useEffect(() => {
    ...
    const fetchMenuData = async () => {
      try {
        ...
        const menuRes = await fetch(`/api/canteens/${activeCanteenId}/menu`);
        ...
        // Default selection configuration fallback
  ...
  const handleToggleAvailability = async (item: MenuItem) => {
    ...
    try {
      // Hits your status modification parameters api path router endpoints
  ...
  // Filter out category selections and group unavailable stock parameters at bottom
